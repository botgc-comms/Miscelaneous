    ...
    ILogger<OpenAiTrophyIllustrator> logger)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (photographs.Count == 0)
            throw new OpenAiUnavailableException("Add at least one trophy photograph before generating an illustration. Rubbings remain available to the engraving reader.");
