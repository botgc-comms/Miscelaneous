...
| Century | £6.19 | £3.93 | £2.43 | 60.9% |

At a £1.00 variable cost, the corresponding contribution margins are approximately 82.5%, 81.5%, 77.4% and 74.6%. These figures exclude VAT, corporation tax, refunds, disputes, foreign-card/FX costs, fixed hosting, development, advertising and human support.
...
- Do not advertise “assisted onboarding” for the Century pack until the included hours are defined. At £3.99 per trophy, uncapped human labour will erase the margin faster than AI usage.
...
The £7.50 single price is useful as a low-friction proof, while the £60 pack should be the principal conversion target. The 50- and 100-credit offers are still profitable under the conservative variable-cost envelope, but they should be sold to clubs that can self-serve; bespoke handling belongs in a separately quoted service.
