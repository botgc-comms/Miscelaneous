...
async function latestPromptFileName(folderPath) {
...
async function nextVersion(folderPath) {
...
function buildCorrectionPrompt(basePrompt, instructions) {
    return [
...
export async function regenerateSingleImage(request) {
